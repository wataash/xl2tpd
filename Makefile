...
# listed in "Note on debugging flags" above
DFLAGS+= -g -DDEBUG_ZLB -DDEBUG_HELLO -DDEBUG_CLOSE -DDEBUG_FLOW -DDEBUG_FILE -DDEBUG_AAA -DDEBUG_PAYLOAD -DDEBUG_CONTROL -DDEBUG_PPPD -DDEBUG_HIDDEN -DDEBUG_ENTROPY -DDEBUG_CONTROL_XMI -DDEBUG_MAGI -DDEBUG_FLOW_MOR -DDEBUG_AUT -DTEST_HIDDEN_XXX_build_broken -DTRUST_PPPD_TO_DIE
# "DFLAGS" above
DFLAGS+= -g -DDEBUG_HELLO -DDEBUG_CLOSE -DDEBUG_FLOW -DDEBUG_PAYLOAD -DDEBUG_CONTROL -DDEBUG_CONTROL_XMIT -DDEBUG_FLOW_MORE -DDEBUG_MAGIC -DDEBUG_ENTROPY -DDEBUG_HIDDEN -DDEBUG_PPPD -DDEBUG_AAA -DDEBUG_FILE -DDEBUG_FLOW -DDEBUG_HELLO -DDEBUG_CLOSE -DDEBUG_ZLB -DDEBUG_AUTH
DFLAGS+= -ggdb3
